...
export const ResetDemoDialog: React.FC<ResetDemoDialogProps> = ({
  ...
  return (
    <Dialog
      ...
      description="This will restore all fictional accounts, initial wallet balances (₹24,750.00 for Arbaz Sayyad), double-entry ledger records, and transactions to their pristine seeded state."
    >
